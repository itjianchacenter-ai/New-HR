...
(function () {
  ...
  const D = {
    ...
    'สาขา': 'Branch', 'วันหยุดบริษัท': 'Company holiday', 'เลขแดง = วันหยุดบริษัท': 'Red = company holiday', 'สัญญา': 'Contract', 'ชื่อ - นามสกุล (ไทย)': 'Full name (TH)', 'แผนก': 'Department', 'พนักงาน': 'Staff', 'สถานะ': 'Status', 'เหตุผล': 'Reason',
    ...
    'ไม่สามารถเชื่อมต่อเซิร์ฟเวอร์ได้ — แตะ ⚙️ ตั้งค่าเซิร์ฟเวอร์ด้านล่าง': 'Cannot reach the server — tap ⚙️ Server settings below',
    // ═ Login พนักงาน ═
    'เข้าสู่ระบบพนักงาน': 'Employee Sign-in',
    'เข้าสู่ระบบครั้งแรกเพียง 2 ขั้นตอน': 'First sign-in takes just 2 steps',
    'ครั้งถัดไประบบจะจดจำให้อัตโนมัติ': 'Next time you\'ll be signed in automatically',
    'ขั้นที่ 1 กรอกเลขบัตรประชาชน 4 ตัวท้าย': 'Step 1 · Enter the last 4 digits of your National ID',
    'ขั้นที่ 2 กรอก PIN (รหัสพนักงานของคุณ)': 'Step 2 · Enter your PIN (employee ID)',
    'เดโม่: เลขท้ายบัตร ': 'Demo: ID last-4 ', ' · PIN ': ' · PIN ',
    'PIN ไม่ถูกต้อง': 'Incorrect PIN',
    'ไม่พบข้อมูลเลขบัตรนี้ในระบบ — กรุณาติดต่อฝ่ายบุคคลเพื่อลงทะเบียน': 'This ID is not registered — please contact HR',
    ...
    'บันทึกเวลาเข้างานเรียบร้อย': 'Clocked in successfully', 'บันทึกเวลาออกงานเรียบร้อย': 'Clocked out successfully',
    ...
    'กรุณาระบุเหตุผลก่อน': 'Please enter a reason first',
    'เช็คอินนอกสถานที่ต้องระบุเหตุผล': 'Off-site check-in requires a reason',
    'กรณีปฏิบัติงานนอกสถานที่ เช่น ออกบูธ ประชุม หรือส่งของ โปรดระบุเหตุผลเพื่อให้ฝ่ายบุคคลตรวจสอบ': 'For off-site work such as events, meetings or deliveries, please give a reason for HR review',
    // ═ คำร้อง ═
    ...
    'ยังไม่มีรายการคำร้อง — เริ่มยื่นได้จากปุ่มด้านบน': 'No requests yet — start one from the buttons above',
    ...
    'ส่งคำร้องเรียบร้อย — อยู่ระหว่างรอการอนุมัติ': 'Request submitted — awaiting approval',
    'ยกเลิกคำร้องเรียบร้อยแล้ว': 'Request cancelled', 'อนุมัติแล้ว ✓': 'Approved ✓', 'ปฏิเสธแล้ว': 'Rejected',
    ...
    // ═ แจ้งเตือน / สลิป ═
    'แจ้งเตือน': 'Notifications', 'แตะเพื่อเปิดดูรายละเอียด': 'Tap to view details',
    'ยังไม่มีสลิปเงินเดือน — จะแสดงทันทีเมื่อฝ่ายบุคคลปิดงวด': 'No payslips yet — they appear as soon as HR closes the period',
